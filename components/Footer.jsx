      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-10">
            ...
            <div className="flex items-center gap-3">
              {socialMedia.map(({ Icon, href, label }) => (
                <a
                  ...
                  className="w-11 h-11 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-200 hover:bg-[#997819] hover:text-white hover:border-[#997819] hover:-translate-y-1 transition-all duration-500"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          <div className="text-left">
            <h3 className="text-[#EAB308] font-black uppercase tracking-[0.3em] text-sm mb-8">
              Navigation
            </h3>
          ...
          {/* Column 3: Expertise (Services) - Styled like Navigation */}
          <div className="text-left">
            <h3 className="text-[#EAB308] font-black uppercase tracking-[0.3em] text-sm mb-8">
              Expertise
            </h3>
        ...
        {/* Bottom Bar */}
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-center items-center gap-3">
